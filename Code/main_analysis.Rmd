...
d_mod1 <- feols(tcr ~ davg + davg^2 + davg^3, odi_plant)
d_mod2 <- feols(tcr ~ davg|Year, odi_plant)
d_mod3 <- feols(tcr ~ davg|naics_3, odi_plant)
d_mod4 <- feols(tcr ~ davg|Year + naics_3, odi_plant)
d_mod5 <- feols(tcr ~ log(fdi_tot)*davg, odi_plant)

d_models <- list(d_mod1, d_mod2, d_mod3, d_mod4, d_mod5)
```
